...
function ContactPage() {
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: isMobile ? "40px 16px" : "60px 24px" }}>
      <div style={{ textAlign: "center", marginBottom: 44 }}>
        <div style={S.badge}>24/7 Support</div>        <h1 style={{ fontSize: isMobile ? 26 : 40, fontWeight: 800, letterSpacing: "-0.03em", marginTop: 12, marginBottom: 10 }}>We're Always Here</h1>
